...
# EMBEDDING_FUNCTION.embed_query = EMBEDDING_FUNCTION.__call__
# EMBEDDING_FUNCTION.embed_documents = EMBEDDING_FUNCTION.__call__
...
EMBEDDING_FUNCTION = embedding_function(ef=model.encode)
def make_db_context_vec_db(db_directory_path: str, **kwargs) -> None:
    ...
    context là tên cột, miêu tả cột
    Args:
    ...
    Chroma.from_documents(docs, EMBEDDING_FUNCTION, persist_directory=str(vector_db_path), collection_name='v_db')
