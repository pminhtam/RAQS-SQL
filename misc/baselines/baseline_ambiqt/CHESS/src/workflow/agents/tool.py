...
class Tool(ABC):
    ...
    def __call__(self, state: SystemState) -> SystemState:
        ...
        self._log_run(state, run_status)        # AttributeError: 'NoneType' object has no attribute 'find_all'
        # Méo hiểu sao lại lỗi này. Nó nằm ở function _get_updates của class Tool
