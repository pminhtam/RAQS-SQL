...
class SystemState(BaseModel):
    ...
    def check_schema_status(self) -> Dict[str, any]:
        ...
        # Nguyên nhân lỗi ở đây :  AttributeError: 'NoneType' object has no attribute 'find_all'
        # Do input không có SQL, nên không thể lấy được ground_truth_sql
    ...
    def get_schema_string(self,
        ...
        elif schema_type == "tentative_with_synonyms":
            schema = self.tentative_schema
            use_synonym = True
        else:
