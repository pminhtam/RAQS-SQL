...
class BasicICLPrompt(object):
    ...
    def format(self, target: dict, max_seq_len: int, max_ans_len: int, scope_factor: int, cross_domain=False, *args, **kwargs):
        # target question
        # print("Format cho từng question nè")
        ...
        return {
            ...
            "db_id": target["db_id"],
            "orig_query" : target.get("orig_query", ""),
            "query2" : target.get("query2", ""),
            "query1" : target.get("query1", ""),
            "extra_map" : target.get("extra_map", {}),
            "extra_table_map" : target.get("extra_table_map", {}),
